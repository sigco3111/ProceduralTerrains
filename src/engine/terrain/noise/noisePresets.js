...
export const NOISE_STACK_PRESETS = {
  ...
  alpineRanges: {
    label: '고산 산맥',
    build: () => makeStack([
      L('fbm', { name: '마시프 베이스', blendMode: 'add', strength: 0.42,
        params: { scale: 0.55, octaves: 4, persistence: 0.5, erosion: 0.25, warp: 0.45 } }),
      L('domainWarp', { name: '범위 굴곡', blendMode: 'add', strength: 0.7, params: { scale: 0.9, octaves: 3 } }),
      L('ridged', { name: '침식된 능선', blendMode: 'add', strength: 0.85,
        params: { scale: 2.0, octaves: 6, sharpness: 2.2, erosion: 0.55, warp: 0.40 } }),
      L('fbm', { name: '산사태 디테일', blendMode: 'add', strength: 0.07,
  ...
  graniteSpires: {
    label: '화강암 첨탑',
    build: () => makeStack([
      L('fbm', { name: '계곡 바닥', blendMode: 'add', strength: 0.28,
        params: { scale: 0.7, octaves: 4, persistence: 0.48, erosion: 0.3, warp: 0.3 } }),
      L('ridged', { name: '첨탑 클러스터', blendMode: 'add', strength: 1.05,
      ...
      L('fbm', { name: '암설 & 사력', blendMode: 'add', strength: 0.09,
  ...
  foothillRanges: {
    label: '구릉 산맥',
    build: () => makeStack([
      L('fbm', { name: '롤링 베이스', blendMode: 'add', strength: 0.45,
        params: { scale: 1.1, octaves: 5, persistence: 0.47, erosion: 0.35, warp: 0.35 } }),
      L('domainWarp', { name: '흐름 왜곡', blendMode: 'add', strength: 0.5, params: { scale: 1.1, octaves: 3 } }),
      L('ridged', { name: '산맥 벨트', blendMode: 'add', strength: 0.55,
      ...
      L('fbm', { name: '부드러운 디테일', blendMode: 'add', strength: 0.05,
