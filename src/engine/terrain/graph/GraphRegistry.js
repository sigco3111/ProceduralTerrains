...
const LANDFORM_DEFINITIONS = [
  ...
  terrainNode({
    ...
    inspector: [
      ...
      number('surrounding', '주변', 0, 1, 0.01, 0.72, { section: '조각', help: 'Blends the carved channel into the surrounding plateau.' }),
      ...
      number('formation', 'Formation', 0, 1, 0.01, 0.62, { section: 'Formation', help: '벽 해체와 지류 협곡을 제어합니다.' }),
      number('detailWarp', '디테일 워프', 0, 1, 0.01, 0.34, { section: 'Formation' }),
      number('alternateStyle', '대체 스타일', 0, 1, 0.01, 0.28, { section: 'Formation' }),
  ...
  terrainNode({
    ...
    inspector: [
      ...
      select('undulation', 'Undulation', AMOUNT_OPTIONS, 'medium', { section: '사구 바다', tier: 'essential', control: 'segmented' }),
...
const definitions = [
  ...
  ...LANDFORM_DEFINITIONS,
  {
    ...
    inspector: [
      number('scale', '크기', 0.1, 8, 0.05, 1, { section: 'Vector Field', tier: 'essential', help: '넓은 굴곡의 크기를 설정합니다.' }),
      number('strength', '세기', 0, 4, 0.01, 0.7, { section: 'Vector Field', tier: 'essential', help: '표고를 직접 변경하지 않고 변위를 제어합니다.' }),
      number('perturbation', '요동', 0, 1, 0.01, 0.28, { section: 'Vector Field', tier: 'essential', help: '벡터 필드의 대칭을 깹니다.' }),
  ...
  },
  {
    ...
    inspector: [
      ...
      number('featureScale', '바디 스케일', 5, 150, 1, 42, { section: '스케일', tier: 'essential', digits: 0, help: 'Sets the neighborhood used to build the large-scale body.' }),
  ...
  },
  {
    ...
    inspector: [
      ...
      number('downcutting', '하방 침식', 0, 2, 0.01, 0.72, { section: '조각', tier: 'essential', help: 'Controls how deeply water cuts through rock and soil.' }),
  ...
  },
  {
    ...
    inspector: [
      ...
      number('outMin', 'Output Min', -4, 4, 0.01, 0), number('outMax', '최대 출력', -4, 4, 0.01, 1),
  ...
  },
  {
    ...
    inspector: [
      ...
      number('octaves', 'Breakup Octaves', 1, 6, 1, 4, { structural: true, section: '해체' }),
  ...
  },
  {
    ...
    inspector: [
      ...
      number('roughness', 'Ridge Breakup', 0, 1, 0.01, 0.58, { section: '바위 구조' }),
  ...
  },
  {
    ...
    inspector: [
      ...
      number('featureScale', '피처 스케일', 2, 160, 1, 30, { section: '일반', tier: 'essential', digits: 0, help: 'Controls the size of talus and scree features.' }),
      ...
      number('sedimentRemoval', 'Sediment Removal', 0, 1, 0.01, 0.18, { section: '퇴적물' }),
  ...
  {
    id: 'naturalErosion', label: 'Natural Erosion', category: '시뮬레이트', color: 'cyan',
  ...
  {
    id: 'slopeTint', label: 'Slope Rock', category: '컬러라이즈', color: 'rose',
