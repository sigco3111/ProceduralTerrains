const SETTINGS_INDEX = [
  ...
  { panelId: 'terrain', tabId: 'erosion', sectionLabel: 'Erosion · Advanced', settingId: 'erosion.erosionEvaporation', label: '증발', keywords: 'erosion evaporation water drainage advanced' },
  ...
  { panelId: 'terrain', tabId: 'import', sectionLabel: '가져오기', settingId: 'terrain.biomeMap', label: '바이옴 맵', keywords: 'biome import replace blend map' },
  ...
  { panelId: 'performance', tabId: 'water', settingId: 'performance.waterQuality', label: '물 품질', keywords: 'water quality reflection detail' },
  ...
  { panelId: 'terrain', tabId: 'surface', subTabId: 'general', settingId: 'performance.terrainDetailOpacity', label: '디테일 불투명도', keywords: 'terrain detail opacity master mix amount overall fade blend properties' },
  ...
  { panelId: 'terrain', tabId: 'surface', subTabId: 'general', settingId: 'performance.terrainDetailNormal', label: '디테일 노멀 강도', keywords: 'terrain normal lighting bump close material properties' },
  ...
  { panelId: 'visuals', tabId: 'sky', settingId: 'visuals.visualsSkyIntensity', label: 'HDR 하늘 강도', keywords: 'visuals hdri hdr sky environment intensity' },
