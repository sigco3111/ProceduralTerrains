...
export const PANEL_META = {
  ...
  noiseLayers: { label: '레이어', title: 'Noise Layers', desc: 'Stack noise layers to shape terrain.', icon: PANEL_ICONS.noiseLayers },
  world: { label: '세계', title: '세계', desc: 'Layout, tiles, chunking and grid.', icon: PANEL_ICONS.world },
  planet: {
    label: '행성',
    title: '행성',
  ...
  biomes: { label: '생태계들', title: '생태계들', desc: 'Climate distribution and masks.', icon: PANEL_ICONS.biomes },
  ...
  export: { label: '내보내기', title: '내보내기', desc: 'Export meshes and textures.', icon: PANEL_ICONS.export },
  performance: { label: '성능 우선', title: '성능 우선', desc: 'GPU, water, fog and cloud budgets.', icon: PANEL_ICONS.performance },
  debug: { label: '디버그', title: '디버그', desc: 'Live stats and diagnostics.', icon: PANEL_ICONS.debug },
