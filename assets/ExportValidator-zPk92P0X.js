import{bz as De,cA as _t,ae as pe,ak as ne,by as Me,bB as fe,bo as ct,cB as Tt,p as Ct,bj as Oe,f as Ft,cC as W,c8 as Pt,cD as Et,a2 as Bt,cE as Wt,cF as He,cG as It,bi as Ot}from"./index-CZPkIRf6.js";import{i as Y,V as I,h as J,a5 as ut,k as Ae,M as Ge,d as Ht,l as Gt,m as Nt,U as Ut,S as $t,a as jt,aq as qt,L as Xt,a1 as Zt,aa as ue,n as Vt,G as Kt,q as mt,a0 as ge,I as Qt,r as Yt,g as Jt,j as dt}from"./three-DQ4dZCk9.js";const ea=`
...
`,po=[{id:"height",label:"높이"},{id:"noise",label:"노이즈"},{id:"slope",label:"경사"},{id:"biome",label:"생태계",soon:!0}];function go(t){switch(t){case"height":return{type:t,enabled:!0,invert:!1,params:{min:0,max:1.35,falloff:.06}};case"noise":return{type:t,enabled:!0,invert:!1,params:{scale:1,threshold:.5,softness:.12}};case"slope":return{type:t,enabled:!0,invert:!1,params:{min:0,max:1,falloff:.1}};case"biome":return{type:t,enabled:!0,invert:!1,params:{biome:0}};default:return{type:t,enabled:!0,invert:!1,params:{}}}}const ta=`
...
`;function ft(t,e,o,a="0.0"){const r=(t.masks||[]).filter(i=>i.enabled!==!1);if(r.length===0)return"1.0";const n=[];return r.some(i=>i.type==="height")&&n.push(`maskHeight(h, uLayerMaskA[${e}])`),r.some(i=>i.type==="noise")&&n.push(o?`maskNoise3(pw, uLayerMaskB[${e}])`:`maskNoise2(pw, uLayerMaskB[${e}])`),!o&&r.some(i=>i.type==="slope")&&n.push(`maskSlope(${a}, uLayerMaskC[${e}])`),n.length?`clamp(${n.join(" * ")}, 0.0, 1.0)`:"1.0"}function Ee(t,e){const o=(t.masks||[]).filter(i=>i.enabled!==!1);if(o.length===0)return 1;let a=1;const r=o.find(i=>i.type==="height");if(r){const{min:i=0,max:l=1.35,falloff:s=.06}=r.params,c=ve(i-s,i+s,e.h),u=ve(l+s,l-s,e.h);let m=Ne(c*u);r.invert&&(m=1-m),a*=m}const n=o.find(i=>i.type==="slope");if(n&&Number.isFinite(e.slope)){const{min:i=0,max:l=1,falloff:s=.1}=n.params,c=ve(i-s,i+s,e.slope),u=ve(l+s,l-s,e.slope);let m=Ne(c*u);n.invert&&(m=1-m),a*=m}return a}function ve(t,e,o){const a=Math.max(0,Math.min(1,(o-t)/(e-t)));return a*a*(3-2*a)}function Ne(t){return t<0?0:t>1?1:t}const aa=`
...
`);return{sig:_t(t),body2d:o,body3d:a}}function So(t,{solo:e=null}={}){const o=new Array(pe).fill(0),a=new Array(pe).fill(1),r=new Array(pe).fill(0),n=[],i=[],l=[],s=[],c=[];for(let u=0;u<pe;u++)n.push([0,0,0,0]),i.push([0,0,0,0]),l.push([0,0,0,0]),s.push([0,0,0,0]),c.push([0,0,0,0]);for(const{layer:u,slot:m}of De(t)){const f=ne(u.type),h=e&&e!==u.id;o[m]=(u.strength??1)*(u.opacity??1)*(h?0:1),a[m]=f.scaleKey?u.params[f.scaleKey]??1:1,r[m]=Re(u.seedOffset);const p=n[m],d=i[m];(f.paKeys||[]).forEach((g,S)=>{g&&(p[S]=u.params[g]??0)}),(f.pbKeys||[]).forEach((g,S)=>{g&&(d[S]=u.params[g]??0)}),ma(u,l[m],s[m],c[m])}return{strength:o,scale:a,seed:r,paramsA:n,paramsB:i,maskA:l,maskB:s,maskC:c}}function ma(t,e,o,a){const r=t.masks||[],n=r.find(s=>s.type==="height"&&s.enabled!==!1),i=r.find(s=>s.type==="noise"&&s.enabled!==!1),l=r.find(s=>s.type==="slope"&&s.enabled!==!1);n&&(e[0]=n.params.min??0,e[1]=n.params.max??1,e[2]=n.params.falloff??.05,e[3]=n.invert?1:0),i&&(o[0]=i.params.scale??1,o[1]=i.params.threshold??.5,o[2]=i.params.softness??.1,o[3]=i.invert?1:0),l&&(a[0]=l.params.min??0,a[1]=l.params.max??1,a[2]=l.params.falloff??.1,a[3]=l.invert?1:0)}function da(t,e,o,a){var r,n;return Math.hypot(e-t,o-t)*Math.max(((r=a.uAmplitude)==null?void 0:r.value)??1,0)*Math.max(((n=a.uHeightScale)==null?void 0:n.value)??1,1)/ee}function ze(t,e,o,a){if(t.type==="legacy")return e.eval2d(o.x,o.z,t,a);const r=Re(t.seedOffset),n=e.scaleKey?t.params[e.scaleKey]??1:1,i=o.px*n+r,l=o.pz*n+r*1.7+3.1;return e.eval2d?e.eval2d(i,l,t,a):0}function fa(t,e,o,a){var f;const r=a.uniforms,n=r.uFrequency.value,i=r.uSeedOffset.value.x,l=r.uSeedOffset.value.y,s=[{x:e,z:o,px:e*n+i,pz:o*n+l},{x:e+ee,z:o,px:(e+ee)*n+i,pz:o*n+l},{x:e,z:o+ee,px:e*n+i,pz:(o+ee)*n+l}];let c=0,u=0,m=0;for(const{layer:h}of t){const p=ne(h.type),d=(h.strength??1)*(h.opacity??1),g=da(c,u,m,r),S=Ee(h,{h:c,slope:g});if(p.category==="modifier"){p.modJs2?(p.modJs2(s[0],h,d),p.modJs2(s[1],h,d),p.modJs2(s[2],h,d)):p.modHeightJs&&(c=p.modHeightJs(c,h,d,S),u=p.modHeightJs(u,h,d,S),m=p.modHeightJs(m,h,d,S));continue}const b=ze(h,p,s[0],a),v=ze(h,p,s[1],a),x=ze(h,p,s[2],a);c=fe(h.blendMode,c,b*d*S),u=fe(h.blendMode,u,v*d*S),m=fe(h.blendMode,m,x*d*S)}return c*(((f=r.uAmplitude)==null?void 0:f.value)??1)}function wo(t,e,o,a){var m;const r=a.uniforms,n=r.uFrequency.value,i=r.uSeedOffset.value.x,l=r.uSeedOffset.value.y,s={px:e*n+i,pz:o*n+l};let c=0;const u=De(t);if(ht(u))return fa(u,e,o,a);for(const{layer:f}of u){const h=ne(f.type),p=(f.strength??1)*(f.opacity??1);if(h.category==="modifier"){h.modJs2?h.modJs2(s,f,p):h.modHeightJs&&(c=h.modHeightJs(c,f,p,1));continue}const d=Re(f.seedOffset),g=h.scaleKey?f.params[h.scaleKey]??1:1,S=s.px*g+d,b=s.pz*g+d*1.7+3.1;let v=h.eval2d?h.eval2d(S,b,f,a):0;f.type==="legacy"&&(v=h.eval2d(e,o,f,a));const x=Ee(f,{h:c});c=fe(f.blendMode,c,v*p*x)}return c*(((m=r.uAmplitude)==null?void 0:m.value)??1)}function Mo(t,e,o,a,r){var m;const n=r.uniforms,i=n.uPlanetRadius.value*n.uFrequency.value,l=n.uSeedOffset.value.x,s=n.uSeedOffset.value.y,c={px:e*i+l,py:o*i+s,pz:a*i+(s-l)};let u=0;for(const{layer:f}of De(t)){const h=ne(f.type),p=(f.strength??1)*(f.opacity??1);if(h.category==="modifier"){h.modJs3?h.modJs3(c,f,p):h.modHeightJs&&(u=h.modHeightJs(u,f,p,1));continue}const d=Re(f.seedOffset),g=h.scaleKey?f.params[h.scaleKey]??1:1;let S;f.type==="legacy"?S=h.eval3d(e,o,a,f,r):S=h.eval3d?h.eval3d(c.px*g+d,c.py*g+d*1.7+3.1,c.pz*g+d*.7-2.3,f,r):0;const b=Ee(f,{h:u});u=fe(f.blendMode,u,S*p*b)}return u*(((m=n.uAmplitude)==null?void 0:m.value)??1)}const ha=`
...
`;function ba(){return{uWaterAtmosphereInfluence:{value:1},uWaterSunResponse:{value:1},uWaterAmbientResponse:{value:1},uWaterFoamLighting:{value:.65}}}function Do(t,e={}){t&&(t.uWaterAtmosphereInfluence&&(t.uWaterAtmosphereInfluence.value=e.waterAtmosphereInfluence??1),t.uWaterSunResponse&&(t.uWaterSunResponse.value=e.waterSunResponse??1),t.uWaterAmbientResponse&&(t.uWaterAmbientResponse.value=e.waterAmbientResponse??1),t.uWaterFoamLighting&&(t.uWaterFoamLighting.value=e.waterFoamLighting??.65))}const O=256,xa="https://elevation-tiles-prod.s3.dualstack.us-east-1.amazonaws.com/terrarium",Ze=6,ya="rgb(128,0,0)",Ao="표고: AWS Open Data의 지형 타일 (Terrarium) — Mapzen, SRTM 등";function _e(t,e){const o=Math.pow(2,e);return(t%o+o)%o}const Te={satellite:{id:"satellite",label:"위성",shortLabel:"위성",attribution:"영상: Esri World Imagery — Esri, Maxar, Earthstar Geographics & others",missingFill:"#243028",tileUrl(t,e,o){const a=_e(e,t);return`https://server.arcgisonline.com/ArcGIS/rest/services/World_Imagery/MapServer/tile/${t}/${o}/${a}`}},opentopo:{id:"opentopo",label:"지형도",shortLabel:"OpenTopoMap",attribution:"지도: © OpenTopoMap (CC-BY-SA) — © OpenStreetMap 기여자, SRTM",missingFill:"#d8d8d8",tileUrl(t,e,o){const a=_e(e,t),r=["https://a.tile.opentopomap.org","https://b.tile.opentopomap.org","https://c.tile.opentopomap.org"];return`${r[(a+o)%r.length]}/${t}/${a}/${o}.png`}}},Sa="satellite";Te.satellite.attribution;function wa(t){return Te[t]||Te[Sa]}const Ma=[{id:"grand-canyon",name:"그랜드 캐년",blurb:"미국 애리조나 깎인 협곡",bbox:{minLat:35.95,maxLat:36.35,minLon:-112.45,maxLon:-111.95},zoom:11},{id:"everest",name:"에베레스트 산",blurb:"히말라야, 네팔 / 티벳",bbox:{minLat:27.8,maxLat:28.18,minLon:86.7,maxLon:87.1},zoom:11},{id:"fuji",name:"후지 산",blurb:"성층 화산, 일본",bbox:{minLat:35.21,maxLat:35.55,minLon:138.55,maxLon:138.93},zoom:11},{id:"matterhorn",name:"마터호른",blurb:"페닌 알프스, 스위스 / 이탈리아",bbox:{minLat:45.83,maxLat:46.13,minLon:7.46,maxLon:7.86},zoom:11},{id:"grand-teton",name:"그랜드 테톤",blurb:"테톤 산맥, �이오밍 미국",bbox:{minLat:43.58,maxLat:43.92,minLon:-110.98,maxLon:-110.62},zoom:11},{id:"crater-lake",name:"분화구 호수",blurb:"캘데라, 오리건 USA",bbox:{minLat:42.83,maxLat:43.07,minLon:-122.27,maxLon:-121.97},zoom:11},{id:"yosemite",name:"요세미티 계곡",blurb:"캘리포니아 시에라네바다, 미국",bbox:{minLat:37.62,maxLat:37.88,minLon:-119.7,maxLon:-119.4},zoom:11},{id:"big-island",name:"하와이 (빅 아일랜드)",blurb:"마우나로아 & 마우나케아",bbox:{minLat:19.3,maxLat:19.9,minLon:-155.9,maxLon:-155.2},zoom:10},{id:"vatnajokull",name:"Vatnajökull",blurb:"빙하 고지대, 아이슬란드",bbox:{minLat:64.2,maxLat:64.62,minLon:-17.25,maxLon:-16.45},zoom:10},{id:"eiger",name:"아이거 & 융프라우",blurb:"베르니나 알프스 북쪽 면, 스위스",bbox:{minLat:46.5,maxLat:46.62,minLon:7.93,maxLon:8.07},zoom:12},{id:"monte-rosa",name:"몬테 로사",blurb:"스위스 최고 산괴, 페닌 알프스",bbox:{minLat:45.86,maxLat:46,minLon:7.8,maxLon:7.94},zoom:12},{id:"piz-bernina",name:"피츠 베르니나",blurb:"베르니나 산맥 빙하, 엥가딘",bbox:{minLat:46.32,maxLat:46.44,minLon:9.84,maxLon:9.98},zoom:12},{id:"mont-blanc",name:"몽블랑",blurb:"알프스 최고봉, 프랑스 / 이탈리아",bbox:{minLat:45.78,maxLat:45.92,minLon:6.79,maxLon:6.95},zoom:12},{id:"landmannalaugar",name:"란드만날라우가르",blurb:"아이슬란드 유리질암 고지대",bbox:{minLat:63.92,maxLat:64.1,minLon:-19.2,maxLon:-18.95},zoom:11},{id:"askja",name:"아스캬",blurb:"캘데라 & 용암 사막, 아이슬란드 고원",bbox:{minLat:65,maxLat:65.12,minLon:-16.85,maxLon:-16.65},zoom:11},{id:"snaefellsjokull",name:"Snæfellsjökull",blurb:"서부 아이슬란드 빙하 화산",bbox:{minLat:64.74,maxLat:64.86,minLon:-23.88,maxLon:-23.7},zoom:11},{id:"taupo-volcanic",name:"타우포 화산 지대",blurb:"뉴질랜드 지열 지대 & 분화구",bbox:{minLat:-39.3,maxLat:-39.06,minLon:175.55,maxLon:175.82},zoom:11},{id:"mount-cook",name:"아오라키 / 쿡 산",blurb:"남부 알프스, 뉴질랜드",bbox:{minLat:-43.66,maxLat:-43.52,minLon:170.05,maxLon:170.23},zoom:11},{id:"fiordland",name:"밀포드 사운드",blurb:"피오르드랜드 빙하 계곡, 뉴질랜드",bbox:{minLat:-44.72,maxLat:-44.54,minLon:167.78,maxLon:168.02},zoom:11},{id:"fitz-roy",name:"몬테 피츠로이",blurb:"화강암 첨탑, 파타고니아, 아르헨티나",bbox:{minLat:-49.36,maxLat:-49.2,minLon:-73.1,maxLon:-72.92},zoom:11},{id:"torres-del-paine",name:"토레스 델 파이네",blurb:"산괴 및 호수, 칠레 파타고니아",bbox:{minLat:-51.1,maxLat:-50.9,minLon:-73.1,maxLon:-72.8},zoom:11},{id:"denali",name:"데날리",blurb:"북아메리카 최고봉, 알래스카 USA",bbox:{minLat:63,maxLat:63.2,minLon:-151.18,maxLon:-150.8},zoom:11},{id:"kilimanjaro",name:"킬리만자로",blurb:"아프리카 최고봉, 탄자니아",bbox:{minLat:-3.15,maxLat:-2.97,minLon:37.27,maxLon:37.47},zoom:11},{id:"k2",name:"K2",blurb:"카라코람, 파키스탄 / 중국",bbox:{minLat:35.79,maxLat:35.97,minLon:76.41,maxLon:76.61},zoom:11},{id:"aconcagua",name:"아콩카과",blurb:"아메리카 대륙 최고봉, 아르헨티나",bbox:{minLat:-32.74,maxLat:-32.56,minLon:-70.1,maxLon:-69.9},zoom:11},{id:"annapurna",name:"안나푸르나",blurb:"깊은 히말라야 산괴, 네팔",bbox:{minLat:28.5,maxLat:28.68,minLon:83.74,maxLon:83.94},zoom:11},{id:"zion",name:"자이언 캐년",blurb:"사암 협곡, 유타 USA",bbox:{minLat:37.18,maxLat:37.36,minLon:-113.1,maxLon:-112.9},zoom:11},{id:"monument-valley",name:"모뉴먼트 밸리",blurb:"사암 메사, 애리조나 / 유타 USA",bbox:{minLat:36.94,maxLat:37.1,minLon:-110.2,maxLon:-110},zoom:11},{id:"dolomites",name:"돌로미티",blurb:"트레 치메, 이탈리아의 석회암 타워",bbox:{minLat:46.58,maxLat:46.7,minLon:12.25,maxLon:12.4},zoom:12},{id:"mount-rainier",name:"레니어 산",blurb:"빙하 성층 화산, 워싱턴 USA",bbox:{minLat:46.78,maxLat:46.92,minLon:-121.83,maxLon:-121.65},zoom:11},{id:"etna",name:"에트나 산",blurb:"활성 화산, 시칠리아, 이탈리아",bbox:{minLat:37.68,maxLat:37.82,minLon:14.93,maxLon:15.07},zoom:11}];function Ro(t){return Ma.find(e=>e.id===t)||null}const ka={lat:{min:-85,max:85,step:.01},lon:{min:-180,max:180,step:.01},sizeKm:{min:4,max:160,step:1},zoom:{min:6,max:15,step:1}},Ve=85.051,be=(t,e,o)=>Math.min(o,Math.max(e,t)),Da=/([+-]?)(\d+(?:\.\d+)?)\s*(?:°|deg)?(?:\s*(\d+(?:\.\d+)?)\s*['′])?(?:\s*(\d+(?:\.\d+)?)\s*["″])?\s*([NnSsEeWw])?/g;function Aa(t){return String(t).trim().replace(/\u00b0/g,"°").replace(/[′ʼ]/g,"'").replace(/[″ʺ]/g,'"')}function Ra(t,e){if(!e)return t;const o=e.toUpperCase();return o==="S"||o==="W"?-Math.abs(t):o==="N"||o==="E"?Math.abs(t):t}function La(t,e){if(!t)return!0;const o=t.toUpperCase();return e==="lat"?o==="N"||o==="S":o==="E"||o==="W"}function Ke(t,e){const o=t[1]||"",a=parseFloat(`${o}${t[2]}`),r=t[3]!=null?parseFloat(t[3]):0,n=t[4]!=null?parseFloat(t[4]):0,i=t[5]||null;if(![a,r,n].every(Number.isFinite)||!La(i,e)||r<0||r>=60||n<0||n>=60)return null;const l=Math.abs(a)+r/60+n/3600,s=a<0||o==="-"?-l:l;return Ra(s,i)}function Lo(t){if(t==null)return null;const e=Aa(t);if(!e)return null;const o=[...e.matchAll(Da)].filter(l=>l[0].trim().length>0);if(o.length!==2)return null;const a=o.map(l=>l[0]).join("").replace(/[\s,;\t]+/g,""),r=e.replace(/[\s,;\t]+/g,"");if(a!==r)return null;const n=Ke(o[0],"lat"),i=Ke(o[1],"lon");return n==null||i==null||Math.abs(n)>90||Math.abs(i)>180?null:{lat:n,lon:i}}function zo({lat:t,lon:e}){const o=t>=0?"N":"S",a=e>=0?"E":"W";return`${Math.abs(t).toFixed(5)}°${o}, ${Math.abs(e).toFixed(5)}°${a}`}function za({lat:t,lon:e,sizeKm:o,zoom:a}){const r=ka,n=be(+t||0,r.lat.min,r.lat.max),i=be(+e||0,r.lon.min,r.lon.max),l=be(+o||r.sizeKm.min,r.sizeKm.min,r.sizeKm.max),s=l/2/110.574,c=l/2/(111.32*Math.max(Math.cos(n*Math.PI/180),.05));return{id:"custom",name:`Custom ${n.toFixed(2)}°, ${i.toFixed(2)}°`,blurb:`${Math.round(l)} km area`,bbox:{minLat:Math.max(n-s,-Ve),maxLat:Math.min(n+s,Ve),minLon:Math.max(i-c,-180),maxLon:Math.min(i+c,180)},zoom:Math.round(be(+a||r.zoom.min,r.zoom.min,r.zoom.max))}}function _o(t){const e=za(t),o=pt(e),a=oe(e.bbox.minLon,o),r=oe(e.bbox.maxLon,o),n=re(e.bbox.maxLat,o),i=re(e.bbox.minLat,o),l=Math.floor(r)-Math.floor(a)+1,s=Math.floor(i)-Math.floor(n)+1,c=Math.max(1,Math.round((r-a)*O)),u=Math.max(1,Math.round((i-n)*O)),m=(e.bbox.minLat+e.bbox.maxLat)/2,f=40075016686e-3*Math.cos(m*Math.PI/180)/(O*Math.pow(2,o));return{loc:e,zoom:o,zoomClamped:o<e.zoom,tilesX:l,tilesY:s,outW:c,outH:u,metersPerPixel:f}}function oe(t,e){return(t+180)/360*Math.pow(2,e)}function re(t,e){const o=t*Math.PI/180;return(1-Math.asinh(Math.tan(o))/Math.PI)/2*Math.pow(2,e)}function pt(t){for(let e=t.zoom;e>0;e--){const o=Math.floor(oe(t.bbox.maxLon,e))-Math.floor(oe(t.bbox.minLon,e))+1,a=Math.floor(re(t.bbox.minLat,e))-Math.floor(re(t.bbox.maxLat,e))+1;if(o<=Ze&&a<=Ze)return e}return 1}function _a(t,e){return new Promise(o=>{const a=new Image;a.crossOrigin="anonymous",a.decoding="async",a.onload=()=>o(a),a.onerror=()=>o(null),e&&e.addEventListener("abort",()=>{a.src="",o(null)},{once:!0}),a.src=t})}function Ta(t,e,o){return`${xa}/${t}/${_e(e,t)}/${o}.png`}async function gt(t,e,o,a,{onProgress:r,signal:n}={}){const i=oe(t.minLon,e),l=oe(t.maxLon,e),s=re(t.maxLat,e),c=re(t.minLat,e),u=Math.floor(i),m=Math.floor(l),f=Math.floor(s),h=Math.floor(c),p=m-u+1,d=h-f+1,g=document.createElement("canvas");g.width=p*O,g.height=d*O;const S=g.getContext("2d",{willReadFrequently:!0}),b=p*d;let v=0,x=0;for(let D=f;D<=h;D++)for(let B=u;B<=m;B++){if(n!=null&&n.aborted)throw new DOMException("중단됨","중단 오류");const z=await _a(o(e,B,D),n),P=(B-u)*O,H=(D-f)*O;z?(S.drawImage(z,P,H),x++):(S.fillStyle=a,S.fillRect(P,H,O,O)),v++,r==null||r(v/b)}const k=Math.max(0,Math.round((i-u)*O)),w=Math.max(0,Math.round((s-f)*O)),y=Math.min(g.width-k,Math.max(1,Math.round((l-i)*O))),A=Math.min(g.height-w,Math.max(1,Math.round((c-s)*O))),R=S.getImageData(k,w,y,A);return{imageData:R,width:R.width,height:R.height,ok:x}}function Ca(t,e,o,a=160){const r=Math.min(1,a/Math.max(e,o)),n=Math.max(1,Math.round(e*r)),i=Math.max(1,Math.round(o*r)),l=document.createElement("canvas");l.width=n,l.height=i;const s=l.getContext("2d"),c=s.createImageData(n,i);for(let u=0;u<i;u++)for(let m=0;m<n;m++){const f=Math.min(e-1,Math.floor(m/r)),h=Math.min(o-1,Math.floor(u/r)),p=Math.round(t[h*e+f]*255),d=(u*n+m)*4;c.data[d]=c.data[d+1]=c.data[d+2]=p,c.data[d+3]=255}return s.putImageData(c,0,0),l.toDataURL("image/png")}function Fa(t,e,o,a=160){const r=Math.min(1,a/Math.max(e,o)),n=Math.max(1,Math.round(e*r)),i=Math.max(1,Math.round(o*r)),l=document.createElement("canvas");l.width=n,l.height=i;const s=l.getContext("2d"),c=s.createImageData(n,i);for(let u=0;u<i;u++)for(let m=0;m<n;m++){const f=Math.min(e-1,Math.floor(m/r)),p=(Math.min(o-1,Math.floor(u/r))*e+f)*4,d=(u*n+m)*4;c.data[d]=t[p],c.data[d+1]=t[p+1],c.data[d+2]=t[p+2],c.data[d+3]=255}return s.putImageData(c,0,0),l.toDataURL("image/png")}function To(t){return pt(t)}async function Co(t,e,{onProgress:o,signal:a}={}){const{imageData:r,width:n,height:i,ok:l}=await gt(t,e,Ta,ya,{onProgress:o,signal:a});if(l===0)throw new Error("No elevation tiles could be loaded (network or CORS blocked).");const s=r.data,c=new Float32Array(n*i);for(let u=0,m=0;u<s.length;u+=4,m++)c[m]=s[u]*256+s[u+1]+s[u+2]/256-32768;return{elev:c,width:n,height:i}}async function Fo(t,e,{style:o,onProgress:a,signal:r}={}){const n=wa(o),{imageData:i,width:l,height:s,ok:c}=await gt(t,e,n.tileUrl.bind(n),n.missingFill,{onProgress:a,signal:r});if(c===0)throw new Error(`No ${n.shortLabel} tiles could be loaded (network or CORS blocked).`);return{rgba:new Uint8ClampedArray(i.data),width:l,height:s,style:n.id}}function Po(t,e,o){const a=t.maxLon-t.minLon,r=t.maxLat-t.minLat;return{minLon:t.minLon+e*a,maxLon:t.maxLon+e*a,minLat:t.minLat-o*r,maxLat:t.maxLat-o*r}}function Pa(t,e,o){const{elev:a,width:r,height:n}=t,i=Math.min(Math.max(e,0),1)*(r-1),l=Math.min(Math.max(o,0),1)*(n-1),s=Math.floor(i),c=Math.floor(l),u=Math.min(s+1,r-1),m=Math.min(c+1,n-1),f=i-s,h=l-c,p=a[c*r+s]+(a[c*r+u]-a[c*r+s])*f,d=a[m*r+s]+(a[m*r+u]-a[m*r+s])*f;return p+(d-p)*h}function Eo(t,e,{maxSide:o=4096}={}){let a=1/0,r=1/0,n=-1/0,i=-1/0;for(const v of e)v.cx<a&&(a=v.cx),v.cz<r&&(r=v.cz),v.cx>n&&(n=v.cx),v.cz>i&&(i=v.cz);e.length||(a=r=n=i=0);const l=n-a+1,s=i-r+1,c=t["0,0"]??Object.values(t)[0];if(!c)throw new Error("합성할 고도 패치가 없습니다.");const u=Math.min(1,o/(l*c.width),o/(s*c.height)),m=Math.max(1,Math.round(c.width*u)),f=Math.max(1,Math.round(c.height*u)),h=l*m,p=s*f;let d=1/0,g=-1/0;for(const v of e){const x=t[`${v.cx},${v.cz}`];if(x)for(let k=0;k<x.elev.length;k++){const w=x.elev[k];w<d&&(d=w),w>g&&(g=w)}}Number.isFinite(d)||(d=0,g=1);const S=g>d?g-d:1,b=new Float32Array(h*p);for(const v of e){const x=t[`${v.cx},${v.cz}`];if(!x)continue;const k=(v.cx-a)*m,w=(v.cz-r)*f;for(let y=0;y<f;y++){const A=f>1?y/(f-1):0,R=(w+y)*h+k;for(let D=0;D<m;D++){const B=m>1?D/(m-1):0;b[R+D]=(Pa(x,B,A)-d)/S}}}return{floatData:b,width:h,height:p,minElev:d,maxElev:g,preview:Ca(b,h,p),bounds:{minX:a,minZ:r,maxX:n,maxZ:i,cols:l,rows:s}}}function Ea(t,e,o,a,r){const{rgba:n,width:i,height:l}=t,s=Math.min(Math.max(e,0),1)*(i-1),c=Math.min(Math.max(o,0),1)*(l-1),u=Math.floor(s),m=Math.floor(c),f=Math.min(u+1,i-1),h=Math.min(m+1,l-1),p=s-u,d=c-m,g=(m*i+u)*4,S=(m*i+f)*4,b=(h*i+u)*4,v=(h*i+f)*4;for(let x=0;x<3;x++){const k=n[g+x]+(n[S+x]-n[g+x])*p,w=n[b+x]+(n[v+x]-n[b+x])*p;a[r+x]=Math.round(k+(w-k)*d)}a[r+3]=255}function Bo(t,e,{maxSide:o=4096}={}){let a=1/0,r=1/0,n=-1/0,i=-1/0;for(const g of e)g.cx<a&&(a=g.cx),g.cz<r&&(r=g.cz),g.cx>n&&(n=g.cx),g.cz>i&&(i=g.cz);e.length||(a=r=n=i=0);const l=n-a+1,s=i-r+1,c=t["0,0"]??Object.values(t)[0];if(!c)throw new Error("합성할 이미지 패치가 없습니다.");const u=Math.min(1,o/(l*c.width),o/(s*c.height)),m=Math.max(1,Math.round(c.width*u)),f=Math.max(1,Math.round(c.height*u)),h=l*m,p=s*f,d=new Uint8ClampedArray(h*p*4);for(let g=0;g<d.length;g+=4)d[g]=216,d[g+1]=216,d[g+2]=216,d[g+3]=255;for(const g of e){const S=t[`${g.cx},${g.cz}`];if(!S)continue;const b=(g.cx-a)*m,v=(g.cz-r)*f;for(let x=0;x<f;x++){const k=f>1?x/(f-1):0;for(let w=0;w<m;w++){const y=m>1?w/(m-1):0;Ea(S,y,k,d,((v+x)*h+b+w)*4)}}}return{rgba:d,width:h,height:p,preview:Fa(d,h,p),bounds:{minX:a,minZ:r,maxX:n,maxZ:i,cols:l,rows:s}}}const Ba=`
...
`+Ya)},a.customProgramCacheKey=()=>`windprop:${e}`,a}function _(t,e,o){return Math.max(e,Math.min(o,t))}function $(t,e,o){return t+(e-t)*o}const it=Object.freeze([Object.freeze({grass:900,flowers:80,rocks:180,trees:440,distanceScale:.65,buildMs:1.5,grassDistance:140,nearDistance:80}),Object.freeze({grass:1800,flowers:180,rocks:320,trees:900,distanceScale:1,buildMs:2.5,grassDistance:220,nearDistance:180}),Object.freeze({grass:2800,flowers:260,rocks:480,trees:1400,distanceScale:1.15,buildMs:3,grassDistance:320,nearDistance:280}),Object.freeze({grass:5e3,flowers:450,rocks:800,trees:2500,distanceScale:1.35,buildMs:4,grassDistance:480,nearDistance:420})]),q=4,X=512,T=Object.freeze({grass:0,flower:1,broadleaf:2,conifer:3,bark:4});function we(t,e,o){const a=t%q,r=Math.floor(t/q),n=2/(X/q);return[(a+n+e*(1-n*2))/q,(r+n+o*(1-n*2))/q]}function St(){const t=new Uint8Array(X*X*4),e=X/q,o=(n,i,l,s,c)=>{const u=n%q,m=Math.floor(n/q),f=u*e+i,p=((m*e+l)*X+f)*4;t[p]=s[0],t[p+1]=s[1],t[p+2]=s[2],t[p+3]=c},a=(n,i,l)=>L(n+l*13,i-l*7,l*97);for(let n=0;n<e;n++){const i=n/(e-1);for(let l=0;l<e;l++){const s=l/(e-1);o(T.grass,l,n,[72,138,56],0),o(T.flower,l,n,[82,145,66],0),o(T.broadleaf,l,n,[82,146,72],0),o(T.conifer,l,n,[62,116,78],0);let c=0;for(let y=0;y<9;y++){const A=.08+y*.105,R=.48+a(y,3,1)*.5;if(i>R)continue;const D=i/R,B=A+Math.sin(D*2.4+y)*(.025+y%2*.01),z=(.022+a(y,5,2)*.018)*(1-D*.9);Math.abs(s-B)<z&&(c=255)}if(c){const y=.72+i*.28+a(l,n,3)*.08;o(T.grass,l,n,[82*y,156*y,66*y],c)}const u=Math.abs(s-.5-Math.sin(i*5)*.012)<.018&&i<.78,m=i>.28&&i<.54&&Math.abs(s-(.5+(i-.4)*1.2))<.04,f=s-.5,h=i-.82,p=Math.atan2(h,f)*5,d=.12+Math.cos(p)*.035,g=Math.hypot(f,h)<d;if(u||m||g){const y=g?[250,242,221]:[78,151,63];o(T.flower,l,n,y,255)}const S=(s-.5)/.47,b=(i-.52)/.46,v=S*S+b*b+(a(l>>2,n>>2,4)-.5)*.24,x=a(l,n,5)>.985&&v<.78;if(v<1&&!x){const y=.72+i*.25+a(l>>1,n>>1,6)*.16;o(T.broadleaf,l,n,[91*y,158*y,79*y],255)}let k=!1;for(let y=0;y<3;y++){const A=.08+y*.23,R=.62+y*.18;if(i>=A&&i<=R){const D=(i-A)/(R-A),B=(.46-y*.08)*(1-D);k||(k=Math.abs(s-.5)<B)}}if(k&&a(l,n,7)>.025){const y=.68+i*.2+a(l>>1,n>>1,8)*.12;o(T.conifer,l,n,[68*y,126*y,84*y],255)}const w=.62+a(l>>2,n,9)*.28+Math.sin(s*44)*.08;o(T.bark,l,n,[145*w,106*w,72*w],255)}}const r=new Gt(t,X,X,Nt,Ut);return r.name="procedural-props-foliage-atlas",r.colorSpace=$t,r.wrapS=r.wrapT=jt,r.minFilter=qt,r.magFilter=Xt,r.generateMipmaps=!0,r.needsUpdate=!0,r}function wt(){const t=[],e=[],o=[],a=[],r=[],n=(s,c,u,m=[1,1,1])=>(t.push(s[0],s[1],s[2]),a.push(c[0],c[1]),o.push(u),e.push(m[0],m[1],m[2]),t.length/3-1);return{addQuad:(s,c,u,m,f,h=0,p=1,d=[1,1,1])=>{const g=t.length/3;n(s,we(f,0,0),h,d),n(c,we(f,1,0),h,d),n(u,we(f,1,1),p,d),n(m,we(f,0,1),p,d),r.push(g,g+1,g+2,g,g+2,g+3)},finish:s=>{const c=new Vt;return c.name=s,c.setAttribute("position",new ue(t,3)),c.setAttribute("color",new ue(e,3)),c.setAttribute("aBend",new ue(o,1)),c.setAttribute("uv",new ue(a,2)),c.setIndex(r),c.computeVertexNormals(),c.computeBoundingSphere(),c}}}function ke(t,{angle:e=0,width:o=1,height:a=1,y:r=0,x:n=0,z:i=0,tile:l,bendBottom:s=0,bendTop:c=1}){const u=Math.cos(e)*o*.5,m=Math.sin(e)*o*.5;t.addQuad([n-u,r,i-m],[n+u,r,i+m],[n+u,r+a,i+m],[n-u,r+a,i-m],l,s,c)}function ae({name:t,cards:e,tile:o,width:a=1,height:r=1}){const n=wt();for(let i=0;i<e;i++)ke(n,{angle:i/e*Math.PI,width:a,height:r,tile:o});return n.finish(t)}function st(t,{height:e,bottomRadius:o,topRadius:a,segments:r=6}){for(let n=0;n<r;n++){const i=n/r*Math.PI*2,l=(n+1)/r*Math.PI*2;t.addQuad([Math.cos(i)*o,0,Math.sin(i)*o],[Math.cos(l)*o,0,Math.sin(l)*o],[Math.cos(l)*a,e,Math.sin(l)*a],[Math.cos(i)*a,e,Math.sin(i)*a],T.bark,0,.12)}}function me(t,e=!1){const o=t==="conifer"?T.conifer:T.broadleaf;if(e)return ae({name:`${t}-far`,cards:2,tile:o,width:t==="conifer"?.58:.72,height:1});const a=wt();if(t==="conifer"){st(a,{height:.78,bottomRadius:.045,topRadius:.018});const r=[{y:.18,h:.55,w:.62},{y:.38,h:.48,w:.49},{y:.57,h:.43,w:.36}];for(const n of r)for(let i=0;i<3;i++)ke(a,{angle:i*Math.PI/3,width:n.w,height:n.h,y:n.y,tile:o,bendBottom:.22,bendTop:.72})}else{st(a,{height:.64,bottomRadius:.06,topRadius:.025});const r=[[-.12,.43,.02,.56,.48],[.14,.48,-.05,.52,.46],[0,.55,.09,.62,.45]];for(const[n,i,l,s,c]of r)ke(a,{angle:.15,width:s,height:c,x:n,y:i,z:l,tile:o,bendBottom:.25,bendTop:.8}),ke(a,{angle:Math.PI*.5+.15,width:s,height:c,x:n,y:i,z:l,tile:o,bendBottom:.25,bendTop:.8})}return a.finish(`${t}-near`)}function Pe(t,e){const o=new Zt(1,t);o.name=e;const a=o.getAttribute("position"),r=[];for(let n=0;n<a.count;n++){const i=a.getX(n),l=a.getY(n),s=a.getZ(n),c=.84+Math.sin(i*4.9+s*2.7)*.1+Math.cos(l*6.1-i*2.2)*.06;a.setXYZ(n,i*c,Math.max(-.72,l*(.82+Math.sin(s*3.8)*.08)),s*c);const u=_(.68+l*.17+Math.sin(i*8.1+s*5.7)*.09,.42,1);r.push(u,u*.98,u*.92)}return o.setAttribute("color",new ue(r,3)),o.computeVertexNormals(),o.computeBoundingSphere(),o}function de(t,e,o=.42){return t.map=e,t.emissive&&(t.emissive.setHex(16777215),t.emissiveMap=e,t.emissiveIntensity=.48),t.alphaTest=o,t.transparent=!1,t.depthWrite=!0,t.side=Ae,t.needsUpdate=!0,t}function le(t){var r;const e=t.onBeforeCompile,o=(r=t.customProgramCacheKey)==null?void 0:r.bind(t),a={center:{value:new I},ranges:{value:new Jt(0,0,1e6,1000001)}};return t.userData.propFadeUniforms=a,t.onBeforeCompile=(n,i)=>{e==null||e(n,i),n.uniforms.uPropFadeCenter=a.center,n.uniforms.uPropFadeRanges=a.ranges,n.vertexShader=`varying vec3 vPropWorldPosition;
${n.vertexShader}`.replace("#include <project_vertex>",`vec4 propWorldPosition = vec4(transformed, 1.0);
    ...
    ${n.fragmentShader}`.replace("#include <alphatest_fragment>",`#include <alphatest_fragment>
      ...
      if (propDither(gl_FragCoord.xy) > propFadeIn * propFadeOut) discard;`)},t.customProgramCacheKey=()=>`${(o==null?void 0:o())??t.type}:prop-distance-fade-v1`,t}function Ja(t){return Number.isFinite(Number(t==null?void 0:t.propQuality))?_(Math.round(t.propQuality),0,3):{performance:0,balanced:1,high:2,ultra:3}[t==null?void 0:t.preset]??2}function $o(t){const e=Et(t),o=St();let a,r;e.type==="rock"?(a=Pe(1,`preview-${e.id}`),r=new Ge({color:e.color,vertexColors:!0,roughness:.92,metalness:0})):(a=e.type==="grass"?ae({name:`preview-${e.id}`,cards:3,tile:T.grass,width:1.1}):e.type==="flower"?ae({name:`preview-${e.id}`,cards:2,tile:T.flower,width:.56}):me(e.type,!1),r=de(new Ge({color:e.color,roughness:.85,metalness:0}),o,e.type==="grass"||e.type==="flower"?.42:.46));const n=new Ht(a,r);return n.name=`prop-asset-preview-${e.id}`,n.scale.set(e.scale*e.width,e.scale*e.height,e.scale*e.width),n.userData.disposePreview=()=>{a.dispose(),r.dispose(),o.dispose()},n}function ce(){return{grass:[],flower:[],rock:[],broadleaf:[],conifer:[]}}class jo{constructor(e){this.scene=e,this.group=new Kt,this.group.name="procedural-props",this.scene.add(this.group),this.atlas=St(),this.grassNearGeometry=ae({name:"grass-near",cards:3,tile:T.grass,width:1.1}),this.grassMidGeometry=ae({name:"grass-mid",cards:2,tile:T.grass,width:1.25}),this.flowerGeometry=ae({name:"flowers",cards:2,tile:T.flower,width:.56}),this.rockNearGeometry=Pe(1,"rock-near"),this.rockFarGeometry=Pe(0,"rock-far"),this.broadleafNearGeometry=me("broadleaf",!1),this.broadleafFarGeometry=me("broadleaf",!0),this.coniferNearGeometry=me("conifer",!1),this.coniferFarGeometry=me("conifer",!0),this.windUniforms=Ka(),this.grassNearMaterial=le(de(Se(this.windUniforms,{strengthMul:1,name:"grass-near"}),this.atlas)),this.grassMidMaterial=le(de(Se(this.windUniforms,{strengthMul:.72,name:"grass-mid"}),this.atlas)),this.flowerMaterial=le(de(Se(this.windUniforms,{strengthMul:.62,name:"flowers"}),this.atlas)),this.treeMaterial=le(de(Se(this.windUniforms,{strengthMul:.18,name:"trees"}),this.atlas,.46)),this.rockMaterial=le(new ut({vertexColors:!0})),this.meshes=[],this._meshPool=new Map,this._sectors=new Map,this._desiredSectors=new Set,this._buildQueue=[],this._queued=new Set,this._scatterKey="",this._centerSectorKey="",this._lastPaintRevision=-1,this._lastPlanetKey="",this._planetBuildState=null,this._lastCenter=new I(1/0,1/0,1/0),this._sectorSize=192,this._quality=2,this._qualityBudget=it[2],this._containsPoint=null,this._tmpMat=new mt,this._tmpPos=new I,this._tmpScale=new I,this._qAlign=new ge,this._qFull=new ge,this._qYaw=new ge,this._qIdentity=new ge,this._up=new I(0,1,0),this._tmpNormal=new I,this._tmpColor=new Y,this._centerScratch=new I,this._planetCamDir=new I,this._planetRef=new I,this._planetT1=new I,this._planetT2=new I,this._planetDir=new I,this._diagnostics={instances:{grass:0,flowers:0,rocks:0,trees:0},lod:{},buildMs:0,samples:0,sectors:0,queuedSectors:0,cacheHits:0,cacheMisses:0,surfaceReadbacks:0,triangles:0,drawCalls:0}}update({mode:e,camera:o,params:a,perf:r=null,boardSize:n,sampler:i,planetSampler:l,paintLayers:s,splineRevision:c=-1,terrainRevision:u=-1,containsPoint:m=null,centerOverride:f=null,dirtyBounds:h=null}){var y;const p=!!a.propsEnabled;if(this.group.visible=p,!p||!o)return;const d=performance.now();this._quality=Ja(r),this._qualityBudget=it[this._quality],this._sectorSize=_((a.chunkSize||128)*1.5,128,256),this._containsPoint=m;const g=this._resolveCenter(e,o,n,f),S=(s==null?void 0:s.revision)??-1,b=Bt(a.propsAssets);this._assetsByType=Object.fromEntries(ye.map(A=>[A.id,Wt(b,A.id)]));const v=[e,a.seed,a.propsDensity,a.propsGrassDensity,a.propsGrass,a.propsFlowers,a.propsRocks,a.propsRockScale,a.propsTreeDensity,a.propsTreeScale,a.seaLevel,n,JSON.stringify(b),c,u].join("|"),x=v!==this._scatterKey,k=S!==this._lastPaintRevision,w=x||k&&(!h||h.all);this._scatterKey=v,this._lastPaintRevision=S,!x&&k&&h&&!h.all&&e!=="planet"&&this._invalidateBounds(h),e==="planet"?this._updatePlanet({camera:o,center:g,params:a,planetSampler:l,scatterChanged:w}):this._updateFlat({mode:e,center:g,params:a,sampler:i,scatterChanged:w,synchronous:!r}),this._diagnostics.buildMs=performance.now()-d,this._diagnostics.surfaceReadbacks=((y=i==null?void 0:i.surfaceField)==null?void 0:y.readbackCount)??(i==null?void 0:i.surfaceReadbacks)??0}_resolveCenter(e,o,a,r=null){if(e==="studio"){if(r)return this._centerScratch.set(r.x,0,r.z);const n=a/2;return this._centerScratch.set(_(o.position.x,-n,n),0,_(o.position.z,-n,n))}return this._centerScratch.copy(o.position)}_updateFlat({mode:e,center:o,params:a,sampler:r,scatterChanged:n,synchronous:i}){var x,k;if(!r)return;n&&(this._sectors.clear(),this._buildQueue.length=0,this._queued.clear());const s=Math.max(32,a.propsCullDistance||760)*this._qualityBudget.distanceScale,c=this._lastCenter.distanceToSquared(o)>=16,u=Math.floor(o.x/this._sectorSize),m=Math.floor(o.z/this._sectorSize),f=`${u}:${m}:${this._quality}`,h=new Set,p=Math.ceil(s/this._sectorSize)+1,d=[];for(let w=m-p;w<=m+p;w++)for(let y=u-p;y<=u+p;y++){const A=(y+.5)*this._sectorSize,R=(w+.5)*this._sectorSize;if(Math.hypot(A-o.x,R-o.z)>s+this._sectorSize*.72)continue;const D=`${y},${w}`;h.add(D),!this._sectors.has(D)&&!this._queued.has(D)&&d.push({key:D,sx:y,sz:w,d:Math.hypot(A-o.x,R-o.z)})}for(const w of this._sectors.keys())h.has(w)||this._sectors.delete(w);d.sort((w,y)=>w.d-y.d);for(const w of d)this._buildQueue.push(w),this._queued.add(w.key);this._desiredSectors=h;const g=n||c||f!==this._centerSectorKey||d.length>0;this._centerSectorKey=f,this._lastCenter.copy(o);let S=!1;const b=performance.now(),v=this._buildQueue.length>0;v&&((x=r.beginBatch)==null||x.call(r,o.x,o.z));try{for(;this._buildQueue.length&&!(!i&&S&&performance.now()-b>=this._qualityBudget.buildMs);){const w=this._buildQueue.shift();this._queued.delete(w.key),this._desiredSectors.has(w.key)&&(this._sectors.set(w.key,this._buildFlatSector(w.sx,w.sz,a,r)),S=!0)}}finally{v&&((k=r.endBatch)==null||k.call(r))}g||S?this._commitFlat(o,s,a):this._diagnostics.cacheHits++,this._diagnostics.sectors=this._sectors.size,this._diagnostics.queuedSectors=this._buildQueue.length}_invalidateBounds(e){const o=Math.floor(e.minX/this._sectorSize),a=Math.floor(e.maxX/this._sectorSize),r=Math.floor(e.minZ/this._sectorSize),n=Math.floor(e.maxZ/this._sectorSize);for(let i=r;i<=n;i++)for(let l=o;l<=a;l++){const s=`${l},${i}`;this._sectors.delete(s),this._queued.has(s)&&(this._queued.delete(s),this._buildQueue=this._buildQueue.filter(c=>c.key!==s))}}_buildFlatSector(e,o,a,r){var m,f,h;const n=ce(),i=e*this._sectorSize,l=o*this._sectorSize,s=i+this._sectorSize,c=l+this._sectorSize,u=_(a.propsDensity??.65,0,2);for(let p=0;p<ye.length;p++){const d=ye[p],g=((m=this._assetsByType)==null?void 0:m[d.id])||[],S=g.length?1:0,b=d.cellSize,v=Math.floor(i/b),x=Math.ceil(s/b),k=Math.floor(l/b),w=Math.ceil(c/b),y=_(a[d.densityParam]??1,0,2);if(!(u<=0||y<=0||S<=0))for(let A=k;A<w;A++)for(let R=v;R<x;R++){const D=31+p*101,B=L(R+D,A-17,a.seed),z=L(R-43,A+D,a.seed),P=R*b+(B-.5)*b*.84,H=A*b+(z-.5)*b*.84;if(P<i||P>=s||H<l||H>=c||this._containsPoint&&!this._containsPoint(P,H)||(d.id==="broadleaf"||d.id==="conifer")&&!this._treeSpacingWinner(R,A,a.seed,D))continue;const ie=L(R+D*2,A-D*3,a.seed),se=((f=r.paintDensityForTypeAt)==null?void 0:f.call(r,d.id,P,H))??(d.id==="grass"||d.id==="flower"?((h=r.paintDensityAt)==null?void 0:h.call(r,P,H))??0:0),G=_(u*(y+se)*S*(d.density??1),0,1);if(ie>G)continue;const K=r.sampleAt(P,H);this._diagnostics.samples++;const Q=rt(P,H,a.seed,D);if(!nt(d,K,a,{roll:ie,macro:Q}))continue;const U=He(g,L(R-D*5,A+D*7,a.seed));U&&n[d.render].push(this._composeItem(d,K,R,A,a,ie,null,U))}}return this._diagnostics.cacheMisses++,n}_treeSpacingWinner(e,o,a,r){const n=L(e+r,o-r,a);return n>=L(e-1+r,o-r,a)&&n>=L(e+1+r,o-r,a)&&n>=L(e+r,o-1-r,a)&&n>=L(e+r,o+1-r,a)}_composeItem(e,o,a,r,n,i,l=null,s=null){const c=L(a+29,r+11,n.seed);let u=$(e.scaleRange[0],e.scaleRange[1],c);e.scaleParam&&(u*=_(n[e.scaleParam]??1,.05,2.5));const m=e.rootDepth??u*(e.rootDepthRatio??0);let f,h,p=e.alignAmount??(e.alignMode===Z.NORMAL?1:0);if(l){const v=o.surfaceRadius-m;f=[l.x*v,l.y*v,l.z*v],e.alignMode===Z.UPRIGHT?h=[l.x,l.y,l.z]:h=[$(l.x,o.normal.x,p),$(l.y,o.normal.y,p),$(l.z,o.normal.z,p)],p=1}else{const[v,x,k]=o.position;f=[v,x-m,k],h=[o.normal.x,o.normal.y,o.normal.z]}let d=u;if(e.id==="grass"){const v=$(.85,1.8,L(a+61,r-23,n.seed));d=[v,u,v]}else e.id==="rock"&&(d=[u*$(.75,1.45,L(a+61,r-23,n.seed)),u*$(.55,.95,L(a-19,r+67,n.seed)),u*$(.7,1.35,L(a+101,r+7,n.seed))]);if(s){const v=s.scale,x=s.width,k=s.height;Array.isArray(d)?d=[d[0]*v*x,d[1]*v*k,d[2]*v*x]:x===k?d*=v*x:d=[d*v*x,d*v*k,d*v*x]}const g=e.id==="grass"?qa(o):e.id==="rock"?Xa(o):e.id==="broadleaf"?at(o,!1):e.id==="conifer"?at(o,!0):Za(L(a+3,r+41,n.seed)),S=It(s),b=s?g.map((v,x)=>$(v,S[x],.68)):g;return{render:e.render,pos:f,normal:h,yaw:L(a,r,n.seed)*Math.PI*2,scale:d,alignAmount:p,tint:b,priority:i,assetId:s==null?void 0:s.id}}_commitFlat(e,o,a){const r=ce();for(const n of this._sectors.values())for(const i of Object.keys(r))r[i].push(...n[i]);this._commitBuckets(r,e,o,a,!1)}_updatePlanet({camera:e,params:o,planetSampler:a,scatterChanged:r}){if(!a)return;const n=this._planetCamDir.copy(e.position).normalize(),i=Math.max(32,o.propsCullDistance||760)*this._qualityBudget.distanceScale,l=Math.max(1,o.planetRadius||16e3),s=Math.max(0,e.position.length()-l),c=this._sectorSize/Math.max(1,o.planetRadius||16e3),u=Math.asin(_(n.y,-1,1)),m=Math.atan2(n.z,n.x),f=s<=Math.max(1e3,i*1.5),h=f?Math.round(s/Math.max(8,i*.08)):"orbit",p=`${Math.round(u/c)}:${Math.round(m/c)}:${h}:${this._quality}:${this._scatterKey}`;if(!f){r||p!==this._lastPlanetKey||this._planetBuildState?(this._planetBuildState=null,this._lastPlanetKey=p,this._commitBuckets(ce(),e.position,i,o,!0),this._diagnostics.sectors=0,this._diagnostics.queuedSectors=0):this._diagnostics.cacheHits++;return}const d=r||p!==this._lastPlanetKey;if(!d&&!this._planetBuildState){this._diagnostics.cacheHits++;return}if(this._lastPlanetKey=p,d){const b=Math.abs(n.y)<.96?this._planetRef.set(0,1,0):this._planetRef.set(1,0,0),v=this._planetT1.crossVectors(b,n).normalize(),x=this._planetT2.crossVectors(n,v).normalize();this._commitBuckets(ce(),e.position,i,o,!0),this._planetBuildState=this._createPlanetBuildState({key:p,dir:n,t1:v,t2:x,radius:i,params:o,planetSampler:a})}const g=this._planetBuildState;(this._processPlanetBuild(g)||g.complete)&&this._commitBuckets(g.buckets,e.position,i,o,!0),this._diagnostics.sectors=1,this._diagnostics.queuedSectors=g.complete?0:1,g.complete&&(this._diagnostics.cacheMisses++,this._planetBuildState=null)}_createPlanetBuildState({key:e,dir:o,t1:a,t2:r,radius:n,params:i,planetSampler:l}){const s=_(i.propsDensity??.65,0,2),c=[Math.ceil(this._qualityBudget.trees*.55),Math.floor(this._qualityBudget.trees*.45)],u={grass:this._qualityBudget.grass,flower:this._qualityBudget.flowers,rock:this._qualityBudget.rocks,broadleaf:c[0],conifer:c[1]},m=ye.map((f,h)=>{var x;const p=Math.ceil(n/f.cellSize),d=_(i[f.densityParam]??1,0,2),g=((x=this._assetsByType)==null?void 0:x[f.id])||[],S=g.length?1:0,b=_(s*d*S*(f.density??1),0,1),v=Math.max(1,Math.PI*(n/f.cellSize)**2);return{desc:f,assets:g,typeIndex:h,range:p,gx:-p,gy:-p,salt:31+h*101,preGate:Math.min(b,u[f.id]*1.7/v)}});return{key:e,dir:o.clone(),t1:a.clone(),t2:r.clone(),radius:n,params:i,planetSampler:l,types:m,typeIndex:0,buckets:ce(),complete:!1}}_processPlanetBuild(e){if(!e||e.complete)return!1;const o=performance.now();let a=!1,r=0;for(;e.typeIndex<e.types.length;){const n=e.types[e.typeIndex],{desc:i,range:l,salt:s}=n;if(n.gy>l){e.typeIndex++;continue}const c=n.gx,u=n.gy;if(n.gx++,n.gx>l&&(n.gx=-l,n.gy++),r++,n.preGate>0&&(!(i.id==="broadleaf"||i.id==="conifer")||this._treeSpacingWinner(c,u,e.params.seed,s))){const m=c*i.cellSize+(L(c+s,u-17,e.params.seed)-.5)*i.cellSize*.84,f=u*i.cellSize+(L(c-43,u+s,e.params.seed)-.5)*i.cellSize*.84;if(Math.hypot(m,f)<=e.radius){const h=L(c+s*2,u-s*3,e.params.seed);if(h<=n.preGate){const p=this._planetDir.copy(e.dir).multiplyScalar(e.params.planetRadius).addScaledVector(e.t1,m).addScaledVector(e.t2,f).normalize(),d=e.planetSampler.sampleAt3D(p.x,p.y,p.z);this._diagnostics.samples++;const g=rt(c*i.cellSize,u*i.cellSize,e.params.seed,s);if(nt(i,d,e.params,{roll:h,macro:g})){const S=He(n.assets,L(c-s*5,u+s*7,e.params.seed));if(!S)continue;e.buckets[i.render].push(this._composeItem(i,d,c,u,e.params,h,p,S)),a=!0}}}}if(!(r&63)&&performance.now()-o>=this._qualityBudget.buildMs)return a}return e.complete=!0,a}_commitBuckets(e,o,a,r,n=!1){const i=this._qualityBudget,l=n?G=>Math.hypot(G.pos[0]-o.x,G.pos[1]-o.y,G.pos[2]-o.z):G=>Math.hypot(G.pos[0]-o.x,G.pos[2]-o.z),s=(G,K,Q=a)=>G.filter(U=>l(U)<=Q).sort((U,he)=>he.priority-U.priority).slice(0,K),c=Math.min(a,i.grassDistance),u=Math.min(c,i.grassDistance*.78),m=s(e.grass,i.grass,c),f=s(e.flower,i.flowers,u),h=s(e.rock,i.rocks),p=Math.ceil(i.trees*.55),d=s(e.broadleaf,p),g=s(e.conifer,Math.max(0,i.trees-p)),S=Math.max(24,r.propsLodDistance||280),b=Math.min(S,i.nearDistance),v=(G,K=b)=>{const Q=[],U=[];for(const he of G)(l(he)<K?Q:U).push(he);return[Q,U]},[x,k]=v(m,Math.min(b,c*.6)),[w,y]=v(h),[A,R]=v(d),[D,B]=v(g),z=_(b*.12,6,28),P=Math.min(b,c*.6),H=_(c*.1,8,36),ie=_(u*.12,6,28),se=_(a*.06,10,42);this._fadeRanges={grassNear:[0,0,P-z,P+z],grassMid:[P-z,P+z,c-H,c],flowers:[0,0,u-ie,u],rocksNear:[0,0,b-z,b+z],rocksFar:[b-z,b+z,a-se,a],broadleafNear:[0,0,b-z,b+z],broadleafFar:[b-z,b+z,a-se,a],coniferNear:[0,0,b-z,b+z],coniferFar:[b-z,b+z,a-se,a]},this._replaceMeshes({grassNear:x,grassMid:k,flowers:f,rockNear:w,rockFar:y,broadleafNear:A,broadleafFar:R,coniferNear:D,coniferFar:B})}_replaceMeshes(e){const o=new Set,a=[["grass-near",this.grassNearGeometry,this.grassNearMaterial,e.grassNear],["grass-mid",this.grassMidGeometry,this.grassMidMaterial,e.grassMid],["flowers",this.flowerGeometry,this.flowerMaterial,e.flowers],["rocks-near",this.rockNearGeometry,this.rockMaterial,e.rockNear],["rocks-far",this.rockFarGeometry,this.rockMaterial,e.rockFar],["broadleaf-near",this.broadleafNearGeometry,this.treeMaterial,e.broadleafNear],["broadleaf-far",this.broadleafFarGeometry,this.treeMaterial,e.broadleafFar],["conifer-near",this.coniferNearGeometry,this.treeMaterial,e.coniferNear],["conifer-far",this.coniferFarGeometry,this.treeMaterial,e.coniferFar]];let r=0,n=0;for(const[i,l,s,c]of a)if(this._updateInstanced(i,l,s,c,o),c.length){n++;const u=l.index?l.index.count/3:l.getAttribute("position").count/3;r+=u*c.length}for(const[i,l]of this._meshPool)o.has(i)||(l.count=0);this.meshes=[...this._meshPool.values()],this._diagnostics.instances={grass:e.grassNear.length+e.grassMid.length,flowers:e.flowers.length,rocks:e.rockNear.length+e.rockFar.length,trees:e.broadleafNear.length+e.broadleafFar.length+e.coniferNear.length+e.coniferFar.length},this._diagnostics.lod=Object.fromEntries(Object.entries(e).map(([i,l])=>[i,l.length])),this._diagnostics.triangles=r,this._diagnostics.drawCalls=n}_updateInstanced(e,o,a,r,n){var c;let i=this._meshPool.get(e);if(!i&&!r.length)return;if(!i||i.instanceMatrix.count<r.length){const u=Math.max(16,2**Math.ceil(Math.log2(r.length||1)));i&&this.group.remove(i),i=new Qt(o,a,u),i.name=`procedural-${e}`,i.frustumCulled=!1,i.instanceMatrix.setUsage(Yt),this._meshPool.set(e,i),this.group.add(i)}i.count=r.length,n.add(e);const l=e.replace(/-([a-z])/g,(u,m)=>m.toUpperCase()),s=((c=this._fadeRanges)==null?void 0:c[l])||[0,0,1e6,1000001];i.userData.propFadeRanges=s,i.onBeforeRender=(u,m,f)=>{const h=i.material.userData.propFadeUniforms;h&&(h.center.value.copy(f.position),h.ranges.value.fromArray(i.userData.propFadeRanges))};for(let u=0;u<r.length;u++){const m=r[u];this._tmpPos.fromArray(m.pos),this._tmpNormal.fromArray(m.normal).normalize(),this._qFull.setFromUnitVectors(this._up,this._tmpNormal),this._qAlign.copy(this._qIdentity).slerp(this._qFull,m.alignAmount??1),this._qYaw.setFromAxisAngle(this._up,m.yaw),this._qAlign.multiply(this._qYaw),Array.isArray(m.scale)?this._tmpScale.fromArray(m.scale):this._tmpScale.setScalar(m.scale),this._tmpMat.compose(this._tmpPos,this._qAlign,this._tmpScale),i.setMatrixAt(u,this._tmpMat),this._tmpColor.fromArray(m.tint||[1,1,1]),i.setColorAt(u,this._tmpColor)}i.instanceMatrix.needsUpdate=!0,i.instanceColor&&(i.instanceColor.needsUpdate=!0)}tickWind(e,o){const a=this.windUniforms;a.uTime.value=e,a.uWindStrength.value=.3*Math.max(0,(o==null?void 0:o.propsWind)??.6),a.uWindSpeed.value=(o==null?void 0:o.propsWindSpeed)??1.6,a.uGustIntensity.value=(o==null?void 0:o.propsGust)??.45}getDiagnostics(){return{...this._diagnostics,instances:{...this._diagnostics.instances},lod:{...this._diagnostics.lod},quality:this._quality}}_clearMeshes(){for(const e of this._meshPool.values())this.group.remove(e);this._meshPool.clear(),this.meshes=[]}dispose(){this._clearMeshes(),this._sectors.clear(),this._planetBuildState=null,this._buildQueue.length=0,this.scene.remove(this.group),[this.grassNearGeometry,this.grassMidGeometry,this.flowerGeometry,this.rockNearGeometry,this.rockFarGeometry,this.broadleafNearGeometry,this.broadleafFarGeometry,this.coniferNearGeometry,this.coniferFarGeometry].forEach(e=>e.dispose()),[this.grassNearMaterial,this.grassMidMaterial,this.flowerMaterial,this.treeMaterial,this.rockMaterial].forEach(e=>e.dispose()),this.atlas.dispose()}}const eo=`
...
`,l=s=>new TextEncoder().encode(s);return{[`${a}/terrain.json`]:l(JSON.stringify(n,null,2)),[`${a}/README.txt`]:l(i)}}const co=4096,uo=1024;function or(t={},e={}){const o=[],a=(i,l)=>o.push({status:i,message:l}),r=Number(t.texRes)||0,n=Number(t.meshRes)||0;return e.worldMode==="planet"&&t.exportPresetId&&t.exportPresetId!=="custom"&&a("warning","엔진 프리셋은 현재 스튜디오 지형 내보내기를 패키징합니다. 행성 내보내기는 네이티브 레이아웃을 유지합니다."),Number(e.boardSize)>0?a("success",`Terrain scale valid (${Math.round(e.boardSize)} m board).`):a("error","지형 스케일이 잘못되었습니다."),!t.includeMesh&&!t.exportHeightmap&&a("error","내보낼 지형 메시 또는 높이맵을 선택하세요."),t.exportHeightmap&&![512,1024,2048,4096].includes(r)?a("error","높이맵 해상도는 512, 1024, 2048 또는 4096이어야 합니다."):t.exportHeightmap&&a("success",`하이맵 ${r} × ${r}.`),r>co?a("error","텍스처 해상도가 지원되는 4096 한계를 초과합니다."):r>=4096&&a("warning","4K 맵은 상당한 GPU 메모리를 필요로 할 수 있습니다."),n>uo?a("error","메시 밀도가 지원되는 1024 한도를 초과합니다."):t.includeMesh&&a("success",`메쉬 밀도 ${n} × ${n}.`),t.exportWater&&!t.exportWaterMask?a("warning","물 마스크 없이 물이 포함되었습니다."):t.exportWaterMask&&a("success","물 마스크 사용 가능."),t.exportSplat&&a("success","바이옴 스플랫 맵 사용 가능."),o}function rr(t){return t.some(e=>e.status==="error")}export{ho as $,Jo as A,je as B,ka as C,ha as D,Ao as E,ko as F,ga as G,na as H,Te as I,pa as J,va as K,ba as L,po as M,Go as N,Po as O,Ha as P,Ia as Q,Ba as R,Wa as S,vt as T,Ho as U,Io as V,Ko as W,Oo as X,wo as Y,So as Z,Re as _,Ma as a,vo as a0,Do as a1,Vo as a2,ao as a3,Xo as a4,qo as a5,Zo as a6,Qo as a7,Sa as a8,jo as a9,Yo as aa,Ro as ab,za as ac,To as ad,Co as ae,Fo as af,Uo as ag,ar as ah,Eo as ai,Bo as aj,Mo as ak,Qe as b,Wo as c,_o as d,$o as e,zo as f,We as g,No as h,go as i,rr as j,zt as k,er as l,tt as m,tr as n,$e as o,Lo as p,ua as q,wa as r,ra as s,aa as t,yo as u,or as v,Ue as w,bo as x,oa as y,xo as z};
